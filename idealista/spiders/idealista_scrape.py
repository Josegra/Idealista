...
class IdealistaScrapeSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.idealista.com/geo/alquiler-viviendas/barrio-de-la-latina/']
    page_number = 2
    ...
    def parse(self, response):
        ...
        next_page = 'https://www.idealista.com/alquiler-viviendas/madrid/moncloa/pagina-' + str(IdealistaScrapeSpider.page_number) + '.htm'
        if IdealistaScrapeSpider.page_number < 20:
